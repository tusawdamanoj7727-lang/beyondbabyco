...
/** Roles shown in the admin user-management UI. */
...
export function resolvePanelRole(
  user: User,
...
export function isUserDeactivated(user: User, profile?: { isActive?: boolean }): boolean {
...
export async function getDbRoleId(
