...
/** Launch catalog hero images — self-hosted generated webps (deployed with the app). */
export const LAUNCH_PRODUCT_IMAGES: Record<string, string> = {
  "baby-wipes": IMAGES.products.baby_wipes,
  "baby-hair-oil-100ml": IMAGES.products.baby_oil,
  ...
  "baby-diaper-rash-cream-50gm": IMAGES.products.baby_cream,
  "baby-shampoo-200ml": IMAGES.products.baby_shampoo,
  "tummy-rollon-40ml": IMAGES.products.baby_oil,
};

/** @deprecated Use LAUNCH_PRODUCT_IMAGES — kept for any legacy imports. */
export const LAUNCH_PRODUCT_PLACEHOLDER_IMAGES = LAUNCH_PRODUCT_IMAGES;

/** Product slug → hero image (self-hosted generated assets). */
export const PRODUCT_IMAGES_BY_SLUG: Record<string, string> = {
  ...LAUNCH_PRODUCT_IMAGES,
