...
export const FEATURED_PRODUCT_CARDS = [
  {
    ...
    gstRate: 18,
    badge: "Available Now",
    description: "Nourishing hair oil with natural ingredients for healthy growth.",
    price: "₹299",
    slug: "baby-hair-oil-100ml",
    comingSoon: false,
  },
  {
    id: 2,
    ...
    gstRate: 18,
    badge: "Available Now",
    description: "Ayurvedic blend for soothing baby massage and better sleep.",
    price: "₹499",
  ...
  },
  {
    ...
    gstRate: 12,
    badge: "Available Now",
    description: "Gentle sulfate-free wash safe for daily use from day 1.",
    price: "₹349",
  ...
  },
  {
    ...
    gstRate: 12,
    badge: "Available Now",
    description: "Deep moisturizing lotion with shea butter. Dermatologically tested.",
    price: "₹299",
  ...
  },
  {
    ...
    gstRate: 12,
    badge: "Available Now",
    description: "Fast-relief cream that creates a protective barrier.",
    price: "₹249",
    slug: "baby-diaper-rash-cream-50gm",
    comingSoon: false,
  },
  {
    id: 6,
    ...
    gstRate: 12,
    badge: "Available Now",
    description: "Tear-free, pH balanced shampoo for delicate scalp.",
    price: "₹299",
  ...
  },
  {
    ...
    gstRate: 12,
    badge: "Available Now",
    description: "Soothing roll-on for gas, colic, and tummy discomfort.",
    price: "₹349",
