...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Audit Logs", href: "/admin/audit-logs", icon: "audit", permission: PERMISSIONS.SETTINGS_MANAGE },
      { label: "Exports", href: "/admin/exports", icon: "reports", permission: PERMISSIONS.REPORTS_VIEW },
