...
import { ANALYTICS_NAV } from "@/lib/analytics/types";
...
export default function AnalyticsNav() {
  ...
  return (
    <nav className="flex gap-1 overflow-x-auto border-b border-cream-200 pb-1 dark:border-green-800" aria-label="Analytics navigation">
