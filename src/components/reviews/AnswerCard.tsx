...
export default function AnswerCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm leading-relaxed text-green-700/90">{answer.body}</p>
      <footer className="mt-3 flex flex-wrap items-center justify-between gap-2 text-xs text-green-700/60">
        ...
        <button
          ...
          className={cn(
            ...
            helpful ? "bg-terra-100 text-terra-800" : "hover:bg-cream-100 text-green-700/80",
          )}
        >
